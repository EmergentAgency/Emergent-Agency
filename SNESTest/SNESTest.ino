...
// Create a SNESpaduino instance (latch, clock, data)
SNESpaduino pad(12, 11, 10);
...
void loop()
{
    ...
    // Map Y, X, A, and B to LEDs
    digitalWrite(13, (btns & BTN_Y) ? HIGH : LOW);
    digitalWrite(14, (btns & BTN_X) ? HIGH : LOW);
    digitalWrite(15, (btns & BTN_A) ? HIGH : LOW);
    digitalWrite(16, (btns & BTN_B) ? HIGH : LOW);
