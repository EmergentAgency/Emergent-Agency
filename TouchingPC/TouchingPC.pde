	...
	for(int i = 0; i < NUM_NODES; i++)
	{
		...
		if(g_abNewMotionData[i])
		{
			...
			if(!g_abNoteOn[i] && g_aiLastestMotion[i] > MIN_SPEED_FOR_NOTE)
			{
				...
				//switch(iRand)
				//{
				//case 0 : MidiNote = 60; break;
				//case 1 : MidiNote = 62; break;
				//case 2 : MidiNote = 65; break;
				//case 3 : MidiNote = 67; break;
				//case 4 : MidiNote = 69; break;
				//case 5 : MidiNote = 72; break;
				//case 6 : MidiNote = 74; break;
				//case 7 : MidiNote = 77; break;
				//case 8 : MidiNote = 79; break;
