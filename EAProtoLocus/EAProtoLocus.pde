 ...
 * 6/4/11 change list:
 * - switched back to regular array notation
 * - added LED fading: instead of boolean, float between 0 and 1 (unlit to fully lit)
 * - attempted to implement sequencing, where node states are stored in an array and accessed at run-time
 */
